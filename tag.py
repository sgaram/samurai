...
settings = {
    ...
    "pname": {},
    "pro_name": {},
    "message":"Salken by. sepriche",
    "message":"team hackbot Indonesia",
    "comment":"""🇮🇩🇮🇩🇮🇩
selfbot by:
╔══════════════┓
✯͜͡❂➣  ™❍✯͜͡sᴇᴘʀɪ_ᴄʜᴇ✯͜͡❂➣ 
╚══════════════┛""",
    "comment1":"""RENTAL BOT PROTECT, SELFBOT ONLY, SELFBOT ASIST DAN ORDER VPS""",
...
✯͜͡❂➣  ❂➣ Help7 [คำสั่งคิกเกอร์]
✯͜͡❂➣  ❂➣ ไอดี @ [ไอดีคนแทค]
✯͜͡❂➣  ❂➣ ชื่อ @ [ชื่อคนแทค]
✯͜͡❂➣  ❂➣ ตัส @ [สเตตัสคนแทค]
✯͜͡❂➣  ❂➣ รูป @ [รูปโปรไฟล์คนแทค]
✯͜͡❂➣  ❂➣ ปก @ [รูปปกคนแทค]
✯͜͡❂➣  ❂➣ คท @ [คทคนแท็ก]
...
✯͜͡❂➣  ❂➣ Mimic on/off
✯͜͡❂➣  ❂➣ MimicList[รายชื่อเลียนแบบ]
✯͜͡❂➣  ❂➣ MimicAdd @[คนที่เลียนแบบ]
✯͜͡❂➣  ❂➣ MimicDel @[คนที่เลิกเลียนแบบ]
...
✯͜͡❂➣  ❂➣ เปิดออก/ปิดออก
✯͜͡❂➣  ❂➣ เปิดติ๊ก/ปิดติ๊ก
✯͜͡❂➣  ❂➣ เปิดบล็อค/ปิดบล็อค
✯͜͡❂➣  ❂➣ เปิดมุด/ปิดมุด
✯͜͡❂➣  ❂➣ เปิดเผือก/ปิดเผือก
✯͜͡❂➣  ❂➣ เปิดอ่าน/ปิดอ่าน
✯͜͡❂➣  ❂➣ เปิดพูด/ปิดพูด
✯͜͡❂➣  ❂➣ เปิดแทค/ปิดแทค
✯͜͡❂➣  ❂➣ เปิดแทค2/ปิดแทค2
✯͜͡❂➣  ❂➣ เปิดแทค3/ปิดแทค3
✯͜͡❂➣  ❂➣ เปิดแทคเจ็บ/ปิดแทคเจ็บ
✯͜͡❂➣  ❂➣ เปิดคท/ปิดคท
✯͜͡❂➣  ❂➣ เปิดตรวจสอบ/ปิดตรวจสอบ
✯͜͡❂➣  ❂➣ เปิดเช็คโพส/ปิดเช็คโพส
✯͜͡❂➣  ❂➣ เปิดแสกน/ปิดแสกน
✯͜͡❂➣  ❂➣ เปิดรับแขก/ปิดรับแขก
✯͜͡❂➣  ❂➣ เปิดส่งแขก/ปิดส่งแขก
✯͜͡❂➣  ❂➣ เปิดทักเตะ/ปิดทักเตะ
✯͜͡❂➣  ❂➣ เปิดข้อความ/ปิดข้อความ
╰══™❍✯͜͡sᴇᴘʀɪ_ᴄʜᴇ✯͜͡❂➣"""
    return helpSetting
...
「contoh : say-th panggil aja sepri」"""
                             ...
                             for target in targets:
                                 try:
                                     ...
                                     try:
                                         ...
                                         line.sendText(msg.to,"Kesalahan yang tidak diketahui telah terdeteksi 😩 Akun Anda mungkin telah dilarang. 😩")
                                         settings["winvite"] = False
                                         break
        if op.type == 25:
            msg = op.message
            if msg.contentType == 13:
               if settings["wblack"] == True:
                   ...
                   if msg.contentMetadata["mid"] in settings["commentBlack"]:
                        ...
                        line.sendText(msg.to,"hapus dari daftar")
                 ...
                 if msg._from in admin: 
                   if msg.contentMetadata["mid"] in settings["blacklist"]:
                        ...
                        settings["wblacklist"] = False
                        line.sendText(msg.to,"Tambahkan akun ini ke daftar hitam")

               elif settings["dblacklist"] == True:
                 if msg._from in admin: 
                   if msg.contentMetadata["mid"] in settings["blacklist"]:
                        del settings["blacklist"][msg.contentMetadata["mid"]]
                        line.sendText(msg.to,"Tambahkan akun ini ke daftar putih.")
...
#==============================================================================#
                    ...
                    start = time.time()
                    line.sendMessage(to, "✯͜͡❂➣  sepribot respon speed")
                    ...
                    line.sendMessage(to, "✯͜͡❂➣   aktif bot {}".format(str(runtime)))
                    ...
                    try:
                        ...
                        ret_ = "╔══[ ™❍✯͜͡sᴇᴘʀɪ_ᴄʜᴇ✯͜͡❂➣]"
                        ret_ += "\n✯͜͡❂➣  ۝ nama ═ {}".format(contact.displayName)
                        ret_ += "\n✯͜͡❂➣  ۝ group ═ {}".format(str(len(grouplist)))
                        ret_ += "\n✯͜͡❂➣  ۝ teman ═ {}".format(str(len(contactlist)))
                        ret_ += "\n✯͜͡❂➣  ۝ blokir ═ {}".format(str(len(blockedlist)))
                        ret_ += "\n✯͜͡❂➣  ══[status] ═ {}".format(contact.statusMessage)
                        ret_ += "\n✯͜͡❂➣  ۝ creator ═ {}".format(creator.displayName)
                        ret_ += "\n╚══[ ™❍✯͜͡sᴇᴘʀɪ_ᴄʜᴇ✯͜͡❂➣]"
...
#==============================================================================#
                    ...
                    try:
                        ...
                        if settings["autoCancel"]["on"] == True:ret_+="\n✯͜͡❂➣   AutoCancel.: " + str(settings["autoCancel"]["members"]) + " → ✔"
                        else: ret_ += "\n✯͜͡❂➣   AutoCancel.  ✘ "						
                    ...
                    try:
                        ...
                        if strnum == "off":
                                ...
                                if settings["lang"] == "JP":
                                    line.sendText(msg.to, " izin dulu kalau mau jepit" + strnum + "tanya boss gue dulu, bang sepri")
                                else:
...
#==============================================================================#
                ...
                elif text.lower() == '.getname':
                    me = line.getContact(lineMID)
                    line.sendMessage(msg.to,"[DisplayName]\n" + me.displayName)
                elif text.lower() == '.getstatus':
                    me = line.getContact(lineMID)
                    line.sendMessage(msg.to,"[StatusMessage]\n" + me.statusMessage)
                elif text.lower() == '.getpicture':
                    me = line.getContact(lineMID)
                    line.sendImageWithURL(msg.to,"http://dl.profile.line-cdn.net/" + me.pictureStatus)
                elif text.lower() == '.getpicturevideo':
                    me = line.getContact(lineMID)
                    line.sendVideoWithURL(msg.to,"http://dl.profile.line-cdn.net/" + me.pictureStatus + "/vp")
                elif text.lower() == '.getcover':
                    me = line.getContact(lineMID)
                    cover = line.getProfileCoverURL(lineMID)    
                    line.sendImageWithURL(msg.to, cover)
                elif text.lower() == '.setcomment':
                    line.sendMessage(msg.to,str(settings["comment"]))
                elif text.lower() == '.setwelcome':
                    line.sendMessage(msg.to, str(settings["welcome"]))
                elif text.lower() == '.setbye':
                    line.sendMessage(msg.to, str(settings["bye"]))
                elif text.lower() == '.setkick':
                    line.sendMessage(msg.to, str(settings["kick"]))
                elif text.lower() == '.setmessage':
                    line.sendMessage(msg.to, str(settings["message"]))
                elif text.lower() == '.setrespontag':
                    line.sendMessage(msg.to, str(settings["Respontag"]))
                elif text.lower() == '.akunbot':
                    gs = line.getGroup(to)
                    targets = []
                    for g in gs.members:
                        if g.displayName in "":
                    ...
                    if targets == []:
                        line.sendMessage(to, "hanya ada sebagian orang digroup ini😂")
                    else:
                        mc = ""
                        for target in targets:
                            mc += sendMessageWithMention(to,target) + "\n"
                        line.sendMessage(to, mc)
                elif text.lower() == '.jsdetect':
                    gs = line.getGroup(to)
                    lists = []
                    for g in gs.members:
                        if g.displayName in "":
                            lists.append(g.mid)
                    if lists == []:
                        line.sendMessage(to, "tidak ada mid js terditeksi🤗")
                    else:
                        mc = ""
                        for mi_d in lists:
                            mc += "->" + mi_d + "\n"
...
#==============================================================================#
                    ...
                    if settings["mimic"]["target"] == {}:
                        ...
                        for mi_d in settings["mimic"]["target"]:
                            mc += "\n✯͜͡❂➣   "+line.getContact(mi_d).displayName
...
#==============================================================================#
                    ...
                    ret_ += "\n✯͜͡❂➣   ชื่อของกลุ่ม : {}".format(str(group.name))
                    ret_ += "\n✯͜͡❂➣   ไอดีของกลุ่ม : {}".format(group.id)
                    ret_ += "\n✯͜͡❂➣   ผู้สร้างกลุ่ม : {}".format(str(gCreator))
                    ret_ += "\n✯͜͡❂➣   จำนวนสมาชิก : {}".format(str(len(group.members)))
                    ret_ += "\n✯͜͡❂➣   จำนวนค้างเชิญ : {}".format(gPending)
                    ret_ += "\n✯͜͡❂➣   ลิ้งของกลุ่ม : {}".format(gQr)
                    ...
                    if msg.toType == 2:
                        ...
                        for mem in group.members:
                            ret_ += "\n✯͜͡❂➣   {}. {}".format(str(no), str(mem.displayName))
                            no += 1
                        ...
                        for gid in groups:
                            ...
                            ret_ += "\n✯͜͡❂➣   {}. {} | {}".format(str(no), str(group.name), str(len(group.members)))
                            no += 1
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                               ...
                               mi_d = Mids[:33]
                               line.createGroup("sᴇᴘʀɪ_ᴄʜᴇ Group",mi_d)
                    ...
                    mi_d = Mids[:33]
                    line.createGroup("sᴇᴘʀɪ_ᴄʜᴇ", mi_d)
                    line.sendText(msg.to,"welcome to room sᴇᴘʀɪ_ᴄʜᴇ SELFBOT")
...
#==============================================================================#
                    ...
                    with requests.session() as web:
                        ...
                        for data in soup.select(".yt-lockup-title > a[title]"):
                            if "&lists" not in data["href"]:
                                datas.append(data)
                        for data in datas:
                            ret_ += "\n✯͜͡❂➣  ══[ {} ]".format(str(data["title"]))
                            ret_ += "\n✯͜͡❂➣   https://www.youtube.com{}".format(str(data["href"]))
                    ...
                    with requests.session() as web:
                        ...
                        for data in datas:
                            ret_ += "\n✯͜͡❂➣  ══[ {} ]".format(str(data["title"]))
                            ret_ += "\n✯͜͡❂➣   https://www.google.com/search?q={}".format(str(data["href"]))
                        ret_ += "\n╚══[ จำนวนที่พบ {} ]".format(len(datas))
                        line.sendMessage(to, str(ret_))
                	...
                	if msg.toType == 2:
                         ...
                         line.sendMessage(receiver,"╔══════════════┓\n✯͜͡❂➣  ❂line://ti/g/" + gurl + "\n✯͜͡❂➣  \n✯͜͡❂➣  ❂Link Groupnya Tanpa Buka Qr\n╚══════════════┛")
...
#==============FINNISHING PROTECT========================#
                ...
                if settings["checkSticker"] == True:
                    ...
                    ret_ = "╔══[ Sticker Info ]"
                    ret_ += "\n✯͜͡❂➣   STICKER ID : {}".format(stk_id)
                    ret_ += "\n✯͜͡❂➣   STICKER PACKAGES ID : {}".format(pkg_id)
                    ret_ += "\n✯͜͡❂➣   STICKER VERSION : {}".format(stk_ver)
                    ret_ += "\n✯͜͡❂➣   STICKER URL : line://shop/detail/{}".format(pkg_id)
                    ret_ += "\n╚══[ Finish ]"
                    line.sendMessage(to, str(ret_))
